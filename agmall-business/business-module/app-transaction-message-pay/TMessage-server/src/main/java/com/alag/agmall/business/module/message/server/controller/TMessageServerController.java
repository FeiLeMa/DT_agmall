package com.alag.agmall.business.module.message.server.controller;
...
public class TMessageServerController {
    ...
    ServerResponse saveMessageWaitingConfirm(@RequestBody TransactionMessage message) throws MessageBizException {
    ...
    ServerResponse saveAndSendMessage(@RequestBody TransactionMessage message) {
        ServerResponse ret = verify(message, true,"message","ConsumerQueue");
        if (!ret.isSuccess()) {
            return ret;
        }
    ...
    void reSendMessage(@RequestBody TransactionMessage message) {
        verify(message, false,"message","ConsumerQueue");
     ...
     * @return
     */
    private ServerResponse verify(TransactionMessage message, boolean b, String... types) throws MessageBizException {
